...
class FileStorage:
    ...
    def all(self, cls=None):
        ...
        Remember the models are the different classes we have declared\
        to represent different tables in our database
        """
    ...
    def reload(self):
        ...
        try:
            ...
            with open(FileStorage.__file_path, 'r') as f:
                temp = json.load(f)
                for key, val in temp.items():
                    self.all()[key] = FileStorage.\
                            __classes[val['__class__']](**val)
